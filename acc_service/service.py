...
# from dir
from fake_instrument_driver import ACC_Instrument
...
def joined(session, details):
    ...
    try:
        yield session.register(callee_control_measurement, service.callee_topics["ACC/control_measurement"])
    ...
    while True: 
        if instrument.heartbeat:
            ...
            session.publish(service.publish_topics["ACC"], *measurement)
